...
ActiveRecord::Schema.define(version: 20170304201530) do
  ...
  create_table "brokers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["store_id"], name: "index_brokers_on_store_id", using: :btree
  end
  ...
  create_table "builds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id"], name: "index_builds_on_store_id", using: :btree
  end
  ...
  create_table "buyers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["proposal_id"], name: "index_buyers_on_proposal_id", using: :btree
    t.index ["store_id"], name: "index_buyers_on_store_id", using: :btree
  end
  ...
  create_table "mailers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.index ["mailable_type", "mailable_id"], name: "index_mailers_on_mailable_type_and_mailable_id", using: :btree
    t.index ["store_id"], name: "index_mailers_on_store_id", using: :btree
    t.index ["userable_type", "userable_id"], name: "index_mailers_on_userable_type_and_userable_id", using: :btree
  end
  ...
  create_table "persons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["store_id"], name: "index_persons_on_store_id", using: :btree
  end

  create_table "proposal_documents", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.string   "state"
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["proposal_id"], name: "index_proposal_documents_on_proposal_id", using: :btree
  end
  ...
  create_table "proposals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["broker_id"], name: "index_proposals_on_broker_id", using: :btree
    t.index ["unit_id"], name: "index_proposals_on_unit_id", using: :btree
  end
  ...
  create_table "units", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                                                         null: false
    t.datetime "updated_at",                                                         null: false
    t.index ["build_id"], name: "index_units_on_build_id", using: :btree
  end
